...
public class DumpIndex {
    ...
    Path        indexpath;          // place where the index will be stored
    ...
    private DumpIndex(String propFile) throws Exception {
        ...
        if (DirectoryReader.indexExists(indexDir)) {
            System.out.println("Index exists in "+indexpath.toAbsolutePath());
...
//            String docContent[] = new String[maxDocLength];
            ...
            for (int i = 0; i < maxDoc; i++) {
                ...
                while ((text = termsEnum.next()) != null) {
                    ...
                    PostingsEnum PosEnum = termsEnum.postings(null, PostingsEnum.FREQS); 
                    PosEnum.nextDoc();
