...
public class GumbelCopulaClassifier implements Classifier<BytesRef>{
     ...
     */
    public GumbelCopulaClassifier(IndexReader indexReader, Analyzer analyzer, Query query, String classFieldName, String... textFieldNames) {
     ...
     */
    protected List<ClassificationResult<BytesRef>> assignClassJaccardList(String inputDocument) throws IOException {
