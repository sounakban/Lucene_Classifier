...
public class KNNClassifyRCV1V2 {
    ...
    HashMap<String, Object> classifyDoc(KNearestNeighborDocumentClassifier knn, String docID, String text) {
    ...
    void performClassification(String indexLoc, String testData, String topics) {
        try {
            ...
            for (Map.Entry<String, String> ent : filesText.entrySet()) {
                ...
                HashMap<String, Object> res = classifyDoc(knn, fileID, fileText);
                //Original Class
            ...
            System.out.println("RCV1.KNNClassifyRCV1V2");
    ...
    public static void main(String[] args) {
        KNNClassifyRCV1V2 cl = new KNNClassifyRCV1V2();
